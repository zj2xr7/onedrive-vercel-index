...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'admin@zjlxdok.onmicrosoft.com',
  ...
  email: 'mailto:admin@zjlxdok.onmicrosoft.com',
